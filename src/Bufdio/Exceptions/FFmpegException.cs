...
namespace Bufdio.Exceptions
{
    ...
    {
        /// <summary>
        /// Instantiate a new <see cref="FFmpegException"/>.
        /// </summary>
        ...
        /// <summary>
        /// Instantiate a new <see cref="FFmpegException"/> by specifying exception message.
        /// </summary>
        ...
        /// <summary>
        /// Instantiate a new <see cref="FFmpegException"/> by specifying error or status code.
        /// </summary>
