...
namespace Bufdio.Exceptions
{
    ...
    {
        /// <summary>
        /// Instantiate a new <see cref="PortAudioException"/>.
        /// </summary>
        ...
        /// <summary>
        /// Instantiate a new <see cref="PortAudioException"/> by specifying exception message.
        /// </summary>
        ...
        /// <summary>
        /// Instantiate a new <see cref="PortAudioException"/> by specifying error or status code.
        /// </summary>
